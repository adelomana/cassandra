...
xSignal, xNoSignal = dataReader3rdExperiment.main(generation=0, label='M3')
cf_mu_0, cf_sd_0, pvalue_0 = calculateStatistics.main(xSignal, xNoSignal)

xSignal, xNoSignal = dataReader3rdExperiment.main(generation=50, label='M3')
cf_mu_50, cf_sd_50, pvalue_50 = calculateStatistics.main(xSignal, xNoSignal)

xSignal, xNoSignal = dataReader3rdExperiment.main(generation=100, label='M3')
cf_mu_100, cf_sd_100, pvalue_100 = calculateStatistics.main(xSignal, xNoSignal)

xSignal, xNoSignal = dataReader3rdExperiment.main(generation=150, label='M3')
cf_mu_150, cf_sd_150, pvalue_150 = calculateStatistics.main(xSignal, xNoSignal)

xSignal, xNoSignal = dataReader3rdExperiment.main(generation=200, label='M3')
cf_mu_200, cf_sd_200, pvalue_200 = calculateStatistics.main(xSignal, xNoSignal)

xSignal, xNoSignal = dataReader3rdExperiment.main(generation=250, label='M3')
cf_mu_250, cf_sd_250, pvalue_250 = calculateStatistics.main(xSignal, xNoSignal)

xSignal, xNoSignal = dataReader3rdExperiment.main(generation=300, label='M3')
...
matplotlib.pyplot.savefig('figure.mutagenized.3.3.pdf')
matplotlib.pyplot.clf()

# save processed data alternative plotting
trajectory=[x,y,z]
jarFile=jarDir+'mutagenized.3.3.pickle'
f=open(jarFile,'wb')
